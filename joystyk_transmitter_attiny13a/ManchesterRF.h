...
#define MinCount 2//0x20 //33 //pulse lower count limit on capture
#define MaxCount 15//0x100 //pulse higher count limit on capture
#define MinLongCount 7//66 //pulse lower count on double pulse
#define MaxLongCount 30//0x200//129 //pulse higher count on double pulse
