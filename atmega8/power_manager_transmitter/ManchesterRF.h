...
#define MinCount 2 //33 //pulse lower count limit on capture
#define MaxCount 15 //pulse higher count limit on capture
#define MinLongCount 7 //pulse lower count on double pulse
#define MaxLongCount 30 //pulse higher count on double pulse
