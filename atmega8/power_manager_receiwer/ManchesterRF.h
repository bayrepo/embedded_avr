...
#define MinCount 8 //33 //pulse lower count limit on capture
#define MaxCount 24 //pulse higher count limit on capture
#define MinLongCount 28 //pulse lower count on double pulse
#define MaxLongCount 40 //pulse higher count on double pulse
